...
class EduBoxScreen extends StatelessWidget {
  const EduBoxScreen({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('EduBox')),
      body: const Center(child: Text('EduBox Screen')),
    );
  }
}
...
class VibeCheckScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('VibeCheck')),
      body: const Center(child: Text('VibeCheck Screen')),
    );
  }
}
...
class SignBridgeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: const Center(child: Text('SignBridge Screen')),
    );
  }
}
